...
public class HairdresserController {
    ...
    private List<HairdresserScheduleDTO> toScheduleDTOs(Authentication authentication, Map<Hairdresser, Set<Block>> todaysBlocks) {
        List<HairdresserScheduleDTO> schedule = Lists.newArrayList();
